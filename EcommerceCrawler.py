...
class Run:
    ...
    def CrawlTokopediaSearch(self):
        ...
        product_last_result_number_in_page.replace('.','')
        ...
        while self.Search.product_page == 0 or (int(self.Search.product_number_of_results) != int(product_last_result_number_in_page) and (self.Search.product_page < self.RunningLog.crawl_max_page or self.RunningLog.crawl_max_page == 0) and (self.Search.product_ordinal < self.RunningLog.crawl_max_ordinal or self.RunningLog.crawl_max_ordinal == 0)):
            ...
            if self.Search.product_page != 1:
                product_paging = "&page="
                remake_paging = product_paging+str(self.Search.product_page - 1)
                ...
                product_last_result_number_in_page = self.Selenium.ExtractElementText("//div[contains(@class, '_1lUX-bZg')]/span/strong[2]").split()[2].replace('.','')
                product_last_result_number_in_page.replace(".","")
                #print(product_last_result_number_in_page)
                #print(3)
                self.Search.product_number_of_results = Enumerate().CleanNumber(self.Selenium.ExtractElementText("//div[contains(@class, '_1lUX-bZg')]/span/strong[3]"))
            if self.Search.product_ordinal < self.RunningLog.crawl_max_ordinal or self.RunningLog.crawl_max_ordinal == 0:
                ...
                print(product_elements_count );input()
                ...
                while (self.Search.element_ordinal < product_elements_count) and (self.Search.product_ordinal < self.RunningLog.crawl_max_ordinal or self.RunningLog.crawl_max_ordinal == 0):
                    ...
                    if product_wrapper_class_type == "ta-inventory":
                        ...
                        while subelement_ordinal < topads_elements_count:
                            ...
                            #print(5)
                            self.Selenium.max_try_count = 1
                            self.Search.merchant_sending_from = self.Selenium.ExtractElementText(''.join([subsub_root_xpath, "/a/div[2]/div/div/div[2]/span[1)]"]))
                            a = self.Selenium.ExtractElementText(''.join([subsub_root_xpath, "/a/div[2]/div/div/div[2]/span[2]"]))
                            ...
                            #print(6)
                            #self.Search.merchant_product_name = self.Selenium.ExtractElementText(''.join([subsub_root_xpath, "/a/div[2]/div/div/div[contains(@class, 'ta-product-shop-location-wrapper')]/span"]))
                        ...
                        self.Search.product_price = Enumerate().CleanNumber(self.Selenium.ExtractElementText(''.join([subsub_root_xpath, "/a/div[2]/div/span/span"])))
                        #print(8)
                        self.Search.merchant_sending_from = self.Selenium.ExtractElementText(''.join([subsub_root_xpath, "/a/div[2]/div/div[1]/div[contains(@class, '_34QLWaaH')]/span[2]"]))
                        #self.Search.merchant_product_name = self.Selenium.ExtractElementText(''.join([subsub_root_xpath, "/a/div[2]/div/div/div[contains(@class, 'ta-product-shop-location-wrapper')]/span"]))
                        a = self.Selenium.ExtractElementText(''.join([subsub_root_xpath, "/a/div[2]/div/div[1]/div[contains(@class, '_34QLWaaH')]/span"]))
                        #print(9)
                        self.Search.product_review_count_total = Enumerate().CleanNumber(self.Selenium.ExtractElementText(''.join([subsub_root_xpath, "/a/div[2]/div/div[2]/span"])))
                        #print(10)
                        ...
                        self.MySQL.Insert(self.Search)
                    self.Selenium.ResetParameters("max_try_count")
                    ws.write(i, 0, self.Search.product_name)
                    ws.write(i, 1, self.Search.product_price)
                    ws.write(i, 2, self.Search.merchant_sending_from)
                    ws.write(i, 3, self.Search.product_review_count_total)
                    ws.write(i, 4,self.Search.product_type)
                    ws.write(i, 5,a)
    ...
    def CrawlTokopediaProduct(self):
        ...
        self.Product.product_discussers_list = self.Selenium.ElementElementsToSeparatedText(separator="@", xpath="//div[contains(@id, 'diskusi')]//*[contains(@class, 'product-talk__name ng-binding')]")
    ...
    def CreateDummies(self):
        ...
        RunningLog.crawl_max_ordinal = 80
        RunningLog.crawl_max_page = 100
        RunningLog.search_input = "Beauty"
